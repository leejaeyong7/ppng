...
const createCard = (dataset, scene, up, index) => {
  ...
  const getPPNGUrl = (qtype, up) => up ? `ppng.html?src=${baseURL}/data/${dataset}/ppng_${qtype}/${scene}.ppng&up=${up}`:`ppng.html?src=${baseURL}data/${dataset}/ppng_${qtype}/${scene}.ppng`
